...
# lapangan = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/lapangan.png").convert_alpha()
# lapangan = pygame.transform.scale(lapangan, (lapanganResX*skala,lapanganResY*skala))

# lapanganBawah = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/lapanganBawah.png").convert_alpha()
# lapanganBawah = pygame.transform.scale(lapanganBawah, (lapanganBawahResX*skala,lapanganBawahResY*skala))

# kiperCyan = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/kiperCyan.png").convert_alpha()
# kiperCyan = pygame.transform.scale(kiperCyan,(robotResX*skala,robotResY*skala))

# backCyan = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/backCyan.png").convert_alpha()
# backCyan = pygame.transform.scale(backCyan,(robotResX*skala,robotResY*skala))

# strikerCyan = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/strikerCyan.png").convert_alpha()
# strikerCyan = pygame.transform.scale(strikerCyan,(robotResX*skala,robotResY*skala))

# kiperMagenta = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/kiperMagenta.png").convert_alpha()
# kiperMagenta = pygame.transform.scale(kiperMagenta,(robotResX*skala,robotResY*skala))

# backMagenta = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/backMagenta.png").convert_alpha()
# backMagenta = pygame.transform.scale(backMagenta,(robotResX*skala,robotResY*skala))

# strikerMagenta = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/strikerMagenta.png").convert_alpha()
# strikerMagenta = pygame.transform.scale(strikerMagenta,(robotResX*skala,robotResY*skala))

# headingKiper = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/headingKiper.png").convert_alpha()
# headingKiper = pygame.transform.scale(headingKiper,(headingResX*skala,headingResY*skala))

# headingBack = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/headingBack.png").convert_alpha()
# headingBack = pygame.transform.scale(headingBack,(headingResX*skala,headingResY*skala))

# headingStriker = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/headingStriker.png").convert_alpha()
# headingStriker = pygame.transform.scale(headingStriker,(headingResX*skala,headingResY*skala))

# musuhCyan = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/musuhCyan.png").convert_alpha()
# musuhCyan = pygame.transform.scale(musuhCyan,(robotResX*skala,robotResY*skala))

# musuhMagenta = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/musuhMagenta.png").convert_alpha()
# musuhMagenta = pygame.transform.scale(musuhMagenta,(robotResX*skala,robotResY*skala))

# bgMenu = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/bgMenu.png").convert_alpha()
# bgMenu = pygame.transform.scale(bgMenu, res)

# bgConf = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/bgConf.png").convert_alpha()
# bgConf = pygame.transform.scale(bgConf, res)

# bgSim = pygame.image.load("C:/Users/LENOVO/BASESTATION/assets/bgSim.png").convert_alpha()
# bgSim = pygame.transform.scale(bgSim, res)